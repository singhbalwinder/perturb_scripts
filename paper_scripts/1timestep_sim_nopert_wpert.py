...
cntl_case = ['ne30_av1c04p2_nopert_cirdpn_fix_02092018']
test_case = ['ne30_av1c04p2_pospert_cirdpn_fix_02092018']
...
#other files needed
var_file       = 'physup_calls_av1c.txt' #'physup_calls_fc5.txt' #'physup_calls_av1c.txt'

#plot related info
xlabel_file = 'xlabels_av1c.txt' #'xlabels_fc5.txt' #'xlabels_av1c.txt'
