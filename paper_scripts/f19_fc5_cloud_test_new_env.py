...
# or not (=0).
#
#NOTE: Python dictionaries CANNOT have duplicate keys, it just picks the last one
cntl_case = {'constance/csmruns/f19_fc5_default_const_int':[1,'Constance(Intel O0)']} #flag to include in plotting or not is not used for control case

cases_tst = {'cori/f19_fc5_default_nondbg_cori_has_int':[1,'Cori Haswell(O2) ']}            
