...
# or not (=0).
#
cntl_case = {'constance/csmruns/ne4_fc5_default_nondebug_const_int':[1,'Constance']} #flag to include in plotting or not is not used for control case

cases_tst = {'cori/experiments/ne4_fc5_default_nondbg_cori_has_int':[1,'Cori Haswell Intel O2'], }
...
#other files needed
inic_cond_file = 'inic_cond_file_list_ne4.txt'
